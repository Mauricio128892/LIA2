document.addEventListener('DOMContentLoaded', () => {
        ...
        // Gerbera 1
        {
            ...
            html: `
                <div class="question-box">
                    <p>¿Qué fue lo que te enamoró de mi ?</p>
    ...
    const mostrarGerbera = (nivel) => {
        ...
        if (nivel === 1) {
            ...
            if (botonGerbera1) { // Asegura que el botón exista antes de añadir el listener
                botonGerbera1.addEventListener('click', () => {
                    ...
                    if (gerberaBody) {
                        ...
                        gerberaBody.classList.remove('fade-in'); // Resetear la animación
                        void gerberaBody.offsetWidth; // Forzar reflow
                        gerberaBody.classList.add('fade-in'); // Aplicar de nuevo
                    }
                });
            }
        } else if (nivel === 2) {
            ...
            // No hay una "respuesta" de entrada aquí, solo la acción de copiar respuestas.
